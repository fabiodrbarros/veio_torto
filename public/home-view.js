...
export function footerView({settings,generic,esc}){
  return `<div class="footer-main"><span class="footer-brand">VEIO TORTO · ARTESANATO FERNANDES</span><nav aria-label="Navegação do rodapé"><a href="/pecas">Peças</a><span aria-hidden="true">·</span><a href="/#artesao">O artesão</a><span aria-hidden="true">·</span><a href="/#contactos">Contactos</a></nav>${generic?`<a href="${esc(generic)}" target="_blank" rel="noopener noreferrer">Falar no WhatsApp ${arrow}</a>`:'<span>Contactos disponíveis em breve.</span>'}</div>
